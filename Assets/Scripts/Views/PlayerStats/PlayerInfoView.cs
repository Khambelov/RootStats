...
namespace RootStats.UI.Views
{
    public class PlayerInfoView : View
    {
        ...
        [SerializeField] private ButtonExtension _editPlayerButton;
        ...
        public override void Init()
        {
            ...
            _editPlayerButton.OnClickAction = DialogsController.Instance.OpenEditPlayerDialog;
        ...
        public string GetAnimationTrigger(string startTrigger)
        {
            switch (startTrigger)
            {
                ...
                case "factionInfo":
                {
                    return ((PlayerFactionsStats) _otherStatsView).InfoViewIsActive ? "faction" : "factionInfo";
                }
                case "player":
                ...
                case "close":
                {
                    ...
                    if (_otherStatsView.IsVisible && ((PlayerFactionsStats) _otherStatsView).InfoViewIsActive)
